...
23. **Promote the Track B NewOwner shell into real cloud workflows.**
    ...
    - Turn the read-only `sidecar-culling-review` connector result into an actual review workspace with explicit local write actions.
