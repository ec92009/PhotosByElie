(() => {
  ...
  const translations = {
    en: {
      ...
      usageEyebrow: "From discovery to use", usageTitle: "Find the image—and know what you can do with it.",
      usageIntro: "Each photograph can carry its verified place, collection, orientation, and availability without taking attention away from the image.",
      wallArtTitle: "Wall art", wallArtBody: "Eligible photographs show available formats, crop previews, finishes, and current pricing before you decide.",
      licensingTitle: "Personal, editorial, or commercial?", licensingBody: "Buying a print and licensing an image are different. Each photograph can guide you to the right request.",
      provenanceTitle: "Where was it made?", provenanceBody: "Country, region, city, year, and a photographer's note provide useful provenance while sensitive exact coordinates remain private.",
      ...
      latestSocial: "Latest social", latestSocialTitle: "New edits, ready to browse.",
    ...
    fr: {
      ...
      usageEyebrow: "De la decouverte a l'usage", usageTitle: "Trouvez l'image — et sachez ce que vous pouvez en faire.",
      usageIntro: "Chaque photographie peut indiquer son lieu verifie, sa collection, son orientation et sa disponibilite sans detourner l'attention de l'image.",
      wallArtTitle: "Art mural", wallArtBody: "Les photographies eligibles indiquent les formats, apercus de recadrage, finitions et prix actuels avant votre choix.",
      licensingTitle: "Usage personnel, editorial ou commercial ?", licensingBody: "Acheter un tirage et obtenir une licence sont deux choses differentes. Chaque photographie peut vous orienter vers la bonne demande.",
      provenanceTitle: "Ou a-t-elle ete realisee ?", provenanceBody: "Pays, region, ville, annee et note du photographe apportent une provenance utile, tandis que les coordonnees exactes sensibles restent privees.",
      ...
      latestSocial: "Dernieres publications", latestSocialTitle: "De nouvelles selections a decouvrir.",
    ...
    es: {
      ...
      usageIntro: "Cada fotografia puede indicar su lugar verificado, coleccion, orientacion y disponibilidad sin quitar protagonismo a la imagen.",
      wallArtTitle: "Arte mural", wallArtBody: "Las fotografias disponibles muestran formatos, vistas de recorte, acabados y precios actuales antes de decidir.",
      licensingTitle: "Uso personal, editorial o comercial?", licensingBody: "Comprar una impresion y licenciar una imagen son cosas distintas. Cada fotografia puede guiarte a la solicitud adecuada.",
      provenanceTitle: "Donde se realizo?", provenanceBody: "Pais, region, ciudad, ano y una nota del fotografo aportan procedencia util, mientras las coordenadas exactas sensibles siguen siendo privadas.",
      ...
      latestSocial: "Ultimas publicaciones", latestSocialTitle: "Nuevas selecciones listas para explorar.",
