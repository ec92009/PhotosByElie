...
| `open_owner_main.py` -> `local_server.py` | Dock-launched legacy local Owner | Legacy compatibility | Keep isolated behind the legacy web Owner route; do not make it a native Backstage dependency. |
