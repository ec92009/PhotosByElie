...
- Treat "bib" as shorthand for the Codex built-in browser: for requests like "show me the local site in bib", open the localhost page in the in-app browser instead of Chrome, Safari, or a file URL.
