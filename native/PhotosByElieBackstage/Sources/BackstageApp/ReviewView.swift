...
/// The production entry point for the Backstage Review workspace.
///
/// This adapter keeps Review available to Xcode Canvas without duplicating
/// the production implementation or connecting previews to Owner services.
struct ReviewView: View {
    @ObservedObject var model: BackstageViewModel
    var isPreviewMode = false

    var body: some View {
        FixtureReviewView(model: model, isPreviewMode: isPreviewMode)
    }
}

#if DEBUG
@MainActor
private enum ReviewPreviewFixtures {
