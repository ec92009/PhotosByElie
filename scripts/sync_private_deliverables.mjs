...
const maybeCommit = async (processedCount, final = false) => {
  ...
  await run("git", ["add", "assets/private-delivery-manifest.json", "assets/media-sidecar.json", "assets/expo-manifest.json", "photos-data.js", "worker/photos-catalog.generated.mjs", "scripts"]);
