...
- Owner Current state is simplified to Analyzed / Blocked / Expo. As of `v71.25`, it reads `10,133` analyzed, `4,341` blocked, and `5,792` Expo photos.
- Owner has an editable local price-list table for digital resolutions, print sizes, frame add-ons, and mock S&H; physical products are buyer-hidden by default and only appear through the deliberate localhost Owner toggle while publishing those edits to the public/Worker catalog remains backlog work.
