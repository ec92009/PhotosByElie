...
This folder contains a curated mobile-audition pack of Pixabay Music guitar candidates for Photos By Elie slideshow work.
...
The manifest `pixabay-guitar-candidates.json` is the source of the audition page entries.
