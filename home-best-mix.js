(() => {
  ...
  const campaignPreviewFrames = {
    ...
    "pinterest-invalides-2026-05-14": [
      "https://download.photos-by-elie.com/media/expo/20220506-154558-03388-a887904b4b_900.jpg",
      "https://download.photos-by-elie.com/media/expo/20220506-160631-03403-51426edaac_900.jpg",
      "https://download.photos-by-elie.com/media/expo/20220506-145248-03337-8deb7b57a5_900.jpg",
      "https://download.photos-by-elie.com/media/expo/20220506-145149-03333-e92838da6f_900.jpg",
      "https://download.photos-by-elie.com/media/expo/20220506-145037-03329-9100ee8314_900.jpg",
      "https://download.photos-by-elie.com/media/expo/20220506-054409-03193-8303575241_900.jpg",
      "https://download.photos-by-elie.com/media/expo/20220506-051024-03188-26c219176a_900.jpg",
      "https://download.photos-by-elie.com/media/expo/20220506-045942-03172-b368612e02_900.jpg",
      "https://download.photos-by-elie.com/media/expo/20220506-044820-03115-d18397db96_900.jpg",
      "https://download.photos-by-elie.com/media/expo/20220506-041124-03096-fad0dd9f78_900.jpg",
    ],
  };
  let activeSection = "";
  ...
  const turnTopStackCard = async () => {
    ...
    const replacementStartLeft = replacement.offsetWidth * -1.08;
    const replacementStartTop = replacementTop + replacement.offsetHeight * .08;
    ...
    replacement.style.top = `${Math.round(replacementStartTop)}px`;
    ...
    const replacementArrival = replacement.animate([
      {
        ...
        top: `${Math.round(replacementStartTop)}px`,
      },
      {
        opacity: 1,
        filter: "saturate(1)",
        left: `${Math.round(replacementStartLeft * .64)}px`,
        top: `${Math.round(replacementStartTop)}px`,
        offset: .2,
      },
      {
