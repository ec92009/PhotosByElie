...
- Retired Sidecar/Bridge automation is no longer a supported PhotoKit path.
  Scheduled and connector work must use authenticated IPC to the signed
  PhotosByElie Backstage app and fail closed when it is unavailable.
