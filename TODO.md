...
11. **Make checkout/order storage production-durable.**
...
12. **Completed: Move product/pricing data out of generated JS constants.**
...
13. **Keep physical products behind Owner review.**
...
15. **Add buyer-facing offer clarity.**
...
17. **Improve public search and SEO.**
...
18. **Create more first-party campaign pages.**
...
19. **Replace temporary `r2.dev` preview URL with a custom media domain.**
...
20. **Create private customer collections for Real Estate and Wedding/Events.**
...
22. **Add Owner state-table browser.**
...
25. **Harden Owner identity and naming.**
...
26. **Add frontend smoke tests for buyer paths.**
...
27. **Keep repo/media cleanup deliberate.**
