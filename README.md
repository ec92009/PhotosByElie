...
- Current visible version: `v89.17`
...
- `slideshow-music.html`: public mini-app with original subdued Spanish/classical guitar cues plus normalized CC0 public-domain Spanish-guitar references, per-track play/pause, seeking, local star ratings, and local delete/hide controls for real estate slideshow use
...
- `assets/music/slideshow-guitar/`: public MP3 cues used by the slideshow music mini-app, including a `public-domain/` source manifest for CC0 Commons clips
