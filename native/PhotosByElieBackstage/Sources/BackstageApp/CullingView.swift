...
/// The production entry point for the Backstage Culling workspace.
///
/// Keeping this small adapter in its own file gives Xcode a stable Canvas
/// target while the production implementation remains shared with the app.
struct CullingView: View {
    @ObservedObject var model: BackstageViewModel
    var isPreviewMode = false

    var body: some View {
        MediaLibraryView(model: model, isPreviewMode: isPreviewMode)
    }
}
