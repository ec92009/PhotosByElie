...
- Daily automation `pbe-daily-social-posts` prepares Facebook, Instagram, and Pinterest post packages from watermarked public assets, publishing only when existing authentication allows it and otherwise leaving ready-to-publish captions and image lists.
