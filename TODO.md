...
- Current visible build: `v86.8`.
- Public site: `https://ec92009.github.io/PhotosByElie/`.
- Local Owner page: use the Dock launcher or the active helper port near 8000, currently `http://localhost:8000/owner.html?v=86.8`.
- Public slideshow music app: `https://ec92009.github.io/PhotosByElie/slideshow-music.html?v=86.8`.
...
- Latest checkpoint is `v86.8`; this file remains the numbered backlog source of truth.
