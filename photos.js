...
const translations = {
  en: {
    ...
    'gallery.fit': 'Fit',
    'gallery.fill': 'Fill',
    'gallery.make_selection': 'Make your own selection',
    ...
    're.shelf.note': 'View files on mobile or download them on a computer. You can capture or share whatever you are seeing in the way that works best for you.',
    ...
    're.output.note': 'Each selection includes both PDF and video formats. Preview either one, or download everything for desktop file handling.',
    ...
    're.status.ready_output': 'Ready for output: {summary}. Preview the PDF, preview the video, or download everything.',
    ...
    're.help.step5': 'Go to Output to preview the PDF, preview the video, or download everything.',
    're.help.step6': 'View files on mobile or download them on a computer; capture or share whatever you are seeing in the way that works best for you.',
  ...
  fr: {
    ...
    'gallery.make_selection': 'Faites votre propre selection',
    'gallery.orientation': 'Orientation',
    ...
    're.shelf.note': 'Consultez les fichiers sur mobile ou telechargez-les sur ordinateur. Capturez ou partagez ce que vous voyez de la maniere qui vous convient.',
    ...
    're.output.note': 'Chaque selection inclut les formats PDF et video. Previsualisez l un ou l autre, ou telechargez tout pour travailler sur ordinateur.',
    ...
    're.status.ready_output': 'Pret pour la sortie : {summary}. Previsualisez le PDF, la video, ou telechargez tout.',
    ...
    're.help.step5': 'Allez a Sortie pour previsualiser le PDF, previsualiser la video, ou tout telecharger.',
    're.help.step6': 'Consultez les fichiers sur mobile ou telechargez-les sur ordinateur; capturez ou partagez ce que vous voyez comme vous preferez.',
  ...
  es: {
    ...
    'gallery.make_selection': 'Haz tu propia seleccion',
    ...
    're.shelf.note': 'Ve los archivos en el movil o descargalos en un ordenador. Puedes capturar o compartir lo que ves de la manera que prefieras.',
    ...
    're.output.note': 'Cada seleccion incluye formatos PDF y video. Previsualiza cualquiera de los dos o descarga todo para trabajar en ordenador.',
    ...
    're.status.ready_output': 'Listo para salida: {summary}. Previsualiza el PDF, el video, o descarga todo.',
    ...
    're.help.step5': 'Ve a Salida para previsualizar el PDF, previsualizar el video o descargar todo.',
    're.help.step6': 'Ve los archivos en el movil o descargalos en un ordenador; captura o comparte lo que ves como prefieras.',
