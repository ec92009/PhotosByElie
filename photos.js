...
const translations = {
  en: {
    ...
    'order.email_notice_body': 'We also sent the download links by email. If it does not appear within a few minutes, check Spam or Junk for Photos By Elie downloads are ready.',
    ...
    're.status.ready_output': 'Ready for output: {summary}. Preview either format, or download the PDF or video file.',
  ...
  fr: {
    ...
    'order.email_notice_body': 'Nous avons aussi envoye les liens de telechargement par email. S il n apparait pas dans quelques minutes, verifiez Spam ou Indesirables pour Photos By Elie downloads are ready.',
    ...
    're.status.ready_output': 'Pret pour la sortie : {summary}. Previsualisez un format, ou telechargez le PDF ou la video.',
  ...
  es: {
    ...
    'order.email_notice_body': 'Tambien enviamos los enlaces de descarga por email. Si no aparece en unos minutos, revisa Spam o Correo no deseado para Photos By Elie downloads are ready.',
    ...
    're.status.ready_output': 'Listo para salida: {summary}. Previsualiza un formato, o descarga el PDF o el video.',
