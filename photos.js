...
const translations = {
  en: {
    ...
    'a11y.gallery_density': 'Gallery grid density',
    'a11y.gallery_density_decrease': 'Zoom out',
    'a11y.gallery_density_increase': 'Zoom in',
    ...
    'gallery.date_from_title': 'From',
    'gallery.date_to_title': 'To',
    'gallery.date_picker': 'Choose a date range',
    'gallery.date_year': 'Year',
    'gallery.any_year': 'Any year',
    'gallery.date_month': 'Month',
    'gallery.any_month': 'Any month',
    'gallery.date_day': 'Day',
    'gallery.any_day': 'Any day',
    'gallery.all_dates': 'All dates',
    'gallery.date_apply': 'Apply',
    ...
    'basket.checkout_started': 'Checkout started · Step 1 of 3: validating your basket...',
    'basket.checking_purchases': 'Step 2 of 3: checking recent purchases...',
    ...
    'basket.creating_checkout': 'Step 3 of 3: preparing secure Stripe checkout...',
    'basket.checkout_still_working': 'Still working · {step} Keep this tab open; this attempt stops safely after 25 seconds.',
    ...
    're.shelf.cloud_saved': 'Cloud saved',
    're.shelf.device_saved': 'Saved on this device',
    're.shelf.gallery_record': 'Gallery record',
    're.shelf.cloud_save_issue': 'Cloud save issue',
    're.shelf.local_only': 'Saved products are stored on this device.',
    're.shelf.syncing': 'Syncing cloud saved products...',
    're.shelf.sync_issue': 'Cloud sync issue: {message}',
    're.shelf.synced': 'Cloud shelf synced ({count} {records}).',
    're.shelf.record': 'record',
    're.shelf.records': 'records',
    're.shelf.available': 'Cloud shelf available. Sync to check saved products.',
    're.shelf.sync': 'Sync',
    're.shelf.syncing_action': 'Syncing...',
    're.shelf.photo': '{count} photo',
    're.shelf.photos': '{count} photos',
    're.shelf.video': '{count} video',
    're.shelf.videos': '{count} videos',
    're.shelf.format_video': 'Video',
    're.shelf.format_selection': 'Selection',
    're.shelf.download': 'Download {format}',
    're.shelf.pending': '{format} pending',
    're.shelf.attention': '{format} needs attention',
    're.shelf.selection_saved': 'Selection saved',
    're.shelf.status_label': 'Product save status',
    're.shelf.open': 'Open {title}',
    're.shelf.rename': 'Rename {title}',
    're.shelf.delete': 'Delete {title}',
    're.shelf.product_name': 'Product name',
    ...
    're.output.share_originals': 'Queue originals',
    're.output.download_originals': 'Download originals',
    ...
    're.output.queue_all': 'Queue all outputs',
    're.output.queue_both': 'Queue PDF + video',
    're.output.queue_pdf': 'Queue PDF',
    're.output.queue_video': 'Queue video',
    're.output.queueing_pdf': 'Queueing PDF...',
    're.output.generating_video': 'Generating video...',
    're.output.saving': 'Saving...',
    're.output.building_originals': 'Preparing originals...',
    ...
    're.progress.almost_done': 'Almost done',
    're.progress.seconds_left': '{seconds}s left',
    're.progress.minutes_left': '{minutes}m {seconds}s left',
    're.cloud.preparing_title': 'Preparing cloud output',
    're.cloud.finding_entry': 'Finding or creating the finished-product shelf entry...',
    're.cloud.creating_entry': 'Creating the shelf entry...',
    're.cloud.reusing_entry': 'Reusing the pending shelf entry...',
    're.cloud.generating_title': 'Generating in the cloud',
    're.cloud.ready_title': 'Cloud output ready',
    're.cloud.ready_detail': 'The finished files are available on the shelf.',
    're.cloud.progress_detail': '{phase} · {percent}% · {elapsed}s',
    're.cloud.phase.queued': 'Waiting for cloud renderer',
    're.cloud.phase.starting': 'Starting cloud renderer',
    're.cloud.phase.loading': 'Loading selection and media',
    're.cloud.phase.pdf-loading': 'Loading PDF photos',
    're.cloud.phase.pdf-rendering': 'Rendering PDF pages',
    're.cloud.phase.pdf-uploading': 'Saving PDF',
    're.cloud.phase.video-rendering': 'Rendering video',
    're.cloud.phase.video-transcoding': 'Converting video to MP4',
    're.cloud.phase.finalizing': 'Finalizing files',
    're.cloud.phase.complete': 'Finishing cloud job',
    're.cloud.ready_shelf': '{formats} ready on the finished-products shelf.',
    're.cloud.timeout': 'Cloud rendering is still running. It will remain on the shelf and can be refreshed later.',
    're.cloud.failed': 'Cloud output could not be prepared.',
    're.cloud.format.pdf': 'PDF',
    're.cloud.format.video': 'video',
    ...
    're.originals.title': 'Originals password',
  ...
  fr: {
    ...
    'a11y.gallery_density': 'Densite de la grille',
    'a11y.gallery_density_decrease': 'Dezoomer',
    'a11y.gallery_density_increase': 'Zoomer',
    ...
    'gallery.date_from_title': 'Debut',
    'gallery.date_to_title': 'Fin',
    'gallery.date_picker': 'Choisir une plage de dates',
    'gallery.date_year': 'Annee',
    'gallery.any_year': 'Toute annee',
    'gallery.date_month': 'Mois',
    'gallery.any_month': 'Tout mois',
    'gallery.date_day': 'Jour',
    'gallery.any_day': 'Tout jour',
    'gallery.all_dates': 'Toutes les dates',
    'gallery.date_apply': 'Appliquer',
    ...
    'basket.checkout_started': 'Checkout lance · Etape 1 sur 3 : validation du panier...',
    'basket.checking_purchases': 'Etape 2 sur 3 : verification des achats recents...',
    ...
    'basket.creating_checkout': 'Etape 3 sur 3 : preparation du checkout Stripe securise...',
    'basket.checkout_still_working': 'Toujours en cours · {step} Gardez cet onglet ouvert ; cette tentative s arrete en toute securite apres 25 secondes.',
    ...
    're.shelf.cloud_saved': 'Enregistre dans le cloud',
    're.shelf.device_saved': 'Enregistre sur cet appareil',
    're.shelf.gallery_record': 'Element de galerie',
    're.shelf.cloud_save_issue': 'Probleme d enregistrement cloud',
    're.shelf.local_only': 'Les produits enregistres sont stockes sur cet appareil.',
    're.shelf.syncing': 'Synchronisation des produits cloud...',
    're.shelf.sync_issue': 'Probleme de synchronisation cloud : {message}',
    're.shelf.synced': 'Rayon cloud synchronise ({count} {records}).',
    're.shelf.record': 'element',
    're.shelf.records': 'elements',
    're.shelf.available': 'Rayon cloud disponible. Synchronisez pour verifier les produits.',
    're.shelf.sync': 'Synchroniser',
    're.shelf.syncing_action': 'Synchronisation...',
    're.shelf.photo': '{count} photo',
    're.shelf.photos': '{count} photos',
    're.shelf.video': '{count} video',
    're.shelf.videos': '{count} videos',
    're.shelf.format_video': 'Video',
    're.shelf.format_selection': 'Selection',
    're.shelf.download': 'Telecharger {format}',
    're.shelf.pending': '{format} en attente',
    're.shelf.attention': '{format} a verifier',
    're.shelf.selection_saved': 'Selection enregistree',
    're.shelf.status_label': 'Etat d enregistrement du produit',
    're.shelf.open': 'Ouvrir {title}',
    're.shelf.rename': 'Renommer {title}',
    're.shelf.delete': 'Supprimer {title}',
    're.shelf.product_name': 'Nom du produit',
    ...
    're.output.share_originals': 'Lancer les originaux',
    're.output.download_originals': 'Telecharger les originaux',
    ...
    're.output.queue_all': 'Lancer toutes les sorties',
    're.output.queue_both': 'Lancer PDF + video',
    're.output.queue_pdf': 'Lancer le PDF',
    're.output.queue_video': 'Lancer la video',
    're.output.queueing_pdf': 'Mise en file du PDF...',
    're.output.generating_video': 'Generation de la video...',
    're.output.saving': 'Enregistrement...',
    're.output.building_originals': 'Preparation des originaux...',
    ...
    're.progress.almost_done': 'Presque termine',
    're.progress.seconds_left': 'Encore {seconds} s',
    're.progress.minutes_left': 'Encore {minutes} min {seconds} s',
    're.cloud.preparing_title': 'Preparation de la sortie cloud',
    're.cloud.finding_entry': 'Recherche ou creation du produit termine...',
    're.cloud.creating_entry': 'Creation du produit sur le rayon...',
    're.cloud.reusing_entry': 'Reutilisation du produit deja en attente...',
    're.cloud.generating_title': 'Generation dans le cloud',
    're.cloud.ready_title': 'Sortie cloud terminee',
    're.cloud.ready_detail': 'Les fichiers termines sont disponibles sur le rayon.',
    're.cloud.progress_detail': '{phase} · {percent} % · {elapsed} s',
    're.cloud.phase.queued': 'En attente du moteur cloud',
    're.cloud.phase.starting': 'Demarrage du moteur cloud',
    're.cloud.phase.loading': 'Chargement de la selection et des medias',
    're.cloud.phase.pdf-loading': 'Chargement des photos du PDF',
    're.cloud.phase.pdf-rendering': 'Rendu des pages PDF',
    're.cloud.phase.pdf-uploading': 'Enregistrement du PDF',
    're.cloud.phase.video-rendering': 'Rendu de la video',
    're.cloud.phase.video-transcoding': 'Conversion de la video en MP4',
    're.cloud.phase.finalizing': 'Finalisation des fichiers',
    're.cloud.phase.complete': 'Fin du traitement cloud',
    're.cloud.ready_shelf': '{formats} disponibles sur le rayon des produits termines.',
    're.cloud.timeout': 'La generation cloud continue. Le produit restera sur le rayon et pourra etre actualise plus tard.',
    're.cloud.failed': 'La sortie cloud n a pas pu etre preparee.',
    're.cloud.format.pdf': 'PDF',
    're.cloud.format.video': 'video',
    ...
    're.originals.title': 'Mot de passe des originaux',
  ...
  es: {
    ...
    'a11y.gallery_density': 'Densidad de la cuadricula',
    'a11y.gallery_density_decrease': 'Alejar',
    'a11y.gallery_density_increase': 'Acercar',
    ...
    'gallery.date_from_title': 'Desde',
    'gallery.date_to_title': 'Hasta',
    'gallery.date_picker': 'Elegir un rango de fechas',
    'gallery.date_year': 'Ano',
    'gallery.any_year': 'Cualquier ano',
    'gallery.date_month': 'Mes',
    'gallery.any_month': 'Cualquier mes',
    'gallery.date_day': 'Dia',
    'gallery.any_day': 'Cualquier dia',
    'gallery.all_dates': 'Todas las fechas',
    'gallery.date_apply': 'Aplicar',
    ...
    'basket.checkout_started': 'Checkout iniciado · Paso 1 de 3: validando la cesta...',
    'basket.checking_purchases': 'Paso 2 de 3: comprobando compras recientes...',
    ...
    'basket.creating_checkout': 'Paso 3 de 3: preparando checkout seguro de Stripe...',
    'basket.checkout_still_working': 'Seguimos trabajando · {step} Mantén esta pestaña abierta; este intento se detiene de forma segura después de 25 segundos.',
    ...
    're.shelf.cloud_saved': 'Guardado en la nube',
    're.shelf.device_saved': 'Guardado en este dispositivo',
    're.shelf.gallery_record': 'Elemento de galeria',
    're.shelf.cloud_save_issue': 'Problema al guardar en la nube',
    're.shelf.local_only': 'Los productos guardados estan almacenados en este dispositivo.',
    're.shelf.syncing': 'Sincronizando productos de la nube...',
    're.shelf.sync_issue': 'Problema de sincronizacion: {message}',
    're.shelf.synced': 'Estante de la nube sincronizado ({count} {records}).',
    're.shelf.record': 'elemento',
    're.shelf.records': 'elementos',
    're.shelf.available': 'Estante de la nube disponible. Sincroniza para comprobar los productos.',
    're.shelf.sync': 'Sincronizar',
    're.shelf.syncing_action': 'Sincronizando...',
    're.shelf.photo': '{count} foto',
    're.shelf.photos': '{count} fotos',
    're.shelf.video': '{count} video',
    're.shelf.videos': '{count} videos',
    're.shelf.format_video': 'Video',
    're.shelf.format_selection': 'Seleccion',
    're.shelf.download': 'Descargar {format}',
    're.shelf.pending': '{format} pendiente',
    're.shelf.attention': '{format} necesita atencion',
    're.shelf.selection_saved': 'Seleccion guardada',
    're.shelf.status_label': 'Estado de guardado del producto',
    're.shelf.open': 'Abrir {title}',
    're.shelf.rename': 'Renombrar {title}',
    're.shelf.delete': 'Eliminar {title}',
    're.shelf.product_name': 'Nombre del producto',
    ...
    're.output.share_originals': 'Preparar originales',
    're.output.download_originals': 'Descargar originales',
    ...
    're.output.queue_all': 'Generar todas las salidas',
    're.output.queue_both': 'Generar PDF + video',
    're.output.queue_pdf': 'Generar PDF',
    're.output.queue_video': 'Generar video',
    're.output.queueing_pdf': 'Enviando PDF...',
    're.output.generating_video': 'Generando video...',
    're.output.saving': 'Guardando...',
    're.output.building_originals': 'Preparando originales...',
    ...
    're.progress.almost_done': 'Casi terminado',
    're.progress.seconds_left': 'Quedan {seconds} s',
    're.progress.minutes_left': 'Quedan {minutes} min {seconds} s',
    're.cloud.preparing_title': 'Preparando salida en la nube',
    're.cloud.finding_entry': 'Buscando o creando el producto terminado...',
    're.cloud.creating_entry': 'Creando el producto en el estante...',
    're.cloud.reusing_entry': 'Reutilizando el producto pendiente...',
    're.cloud.generating_title': 'Generando en la nube',
    're.cloud.ready_title': 'Salida en la nube terminada',
    're.cloud.ready_detail': 'Los archivos terminados estan disponibles en el estante.',
    're.cloud.progress_detail': '{phase} · {percent} % · {elapsed} s',
    're.cloud.phase.queued': 'Esperando al generador en la nube',
    're.cloud.phase.starting': 'Iniciando el generador en la nube',
    're.cloud.phase.loading': 'Cargando seleccion y archivos',
    're.cloud.phase.pdf-loading': 'Cargando fotos del PDF',
    're.cloud.phase.pdf-rendering': 'Generando paginas PDF',
    're.cloud.phase.pdf-uploading': 'Guardando PDF',
    're.cloud.phase.video-rendering': 'Generando video',
    're.cloud.phase.video-transcoding': 'Convirtiendo video a MP4',
    're.cloud.phase.finalizing': 'Finalizando archivos',
    're.cloud.phase.complete': 'Terminando el trabajo en la nube',
    're.cloud.ready_shelf': '{formats} disponibles en el estante de productos terminados.',
    're.cloud.timeout': 'La generacion en la nube continua. El producto permanecera en el estante y se podra actualizar mas tarde.',
    're.cloud.failed': 'No se pudo preparar la salida en la nube.',
    're.cloud.format.pdf': 'PDF',
    're.cloud.format.video': 'video',
    ...
    're.originals.title': 'Contrasena de originales',
...
window.photosByElieFilterPublicHidden = (photos = []) => {
  if (window.photosByElieInputMode.isLocalhost()) return photos;
  if (window.photosByElieHiddenBlacklistFailed) return [];
  if (!window.photosByEliePublicHiddenIds.size) return photos;
...
window.photosByElieHiddenBlacklistReady = (async () => {
  ...
  try {
    ...
    window.photosByEliePublicHiddenIds = new Set();
    window.photosByElieHiddenBlacklistFailed = true;
  }
...
window.photosByElieMediaUrl = (photo, size = 'gallery') => {
  ...
  if (isLocalhostMediaPage && direct) return direct;
...
window.photosByElieVideoDurationLabel = (photo) => (
  ...
  window.photosByElieVideoPosterUrl = (photo) => (
    (isLocalhostMediaPage ? photo?.media?.publicPreview?.posterUrl : '')
