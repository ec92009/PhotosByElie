...
- Current visible version: `v89.15`
...
- `slideshow-music.html`: public mini-app with original subdued Spanish/classical guitar cues, per-track play/pause, seeking, MP3 links, and volume controls for real estate slideshow use
...
- `assets/music/slideshow-guitar/`: public MP3 cues used by the slideshow music mini-app
