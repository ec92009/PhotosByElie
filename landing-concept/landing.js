(() => {
  ...
  const translations = {
    en: {
      ...
      usageIntro: "Find the image that fits by place, time, keywords, or the photographer’s own note.",
      wallArtTitle: "Enjoy it",
      licensingTitle: "Work with it",
      provenanceTitle: "Remember it",
    ...
    fr: {
      ...
      usageIntro: "Trouvez l’image qui vous convient par lieu, époque, mots-clés ou grâce à la note du photographe.",
      wallArtTitle: "Profitez-en",
      licensingTitle: "Travaillez avec elle",
      provenanceTitle: "Gardez-en le souvenir",
      ...
      socialCampaigns: "Campagnes sociales",
    ...
    es: {
      ...
      usageIntro: "Encuentra la imagen que encaja por lugar, época, palabras clave o la nota del fotógrafo.",
      wallArtTitle: "Disfrútala",
      licensingTitle: "Trabaja con ella",
      provenanceTitle: "Guarda el recuerdo",
