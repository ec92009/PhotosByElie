...
- Current visible version: `v89.18`
...
- `slideshow-music.html`: public mini-app with normalized Pixabay guitar audition candidates first, original subdued Spanish/classical guitar cues below, per-track play/pause, seeking, local star ratings, and local delete/hide controls for real estate slideshow use
