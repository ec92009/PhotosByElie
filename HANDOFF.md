...
- In `v140.25`, the Real Estate finished-products shelf no longer shows the manual cloud-sync status banner or Sync button. Its saved-product fetch remains automatic on unlock, reload, and relevant workflow transitions.
