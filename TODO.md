...
1. **Reconcile current Title/Keywords approval state.**
...
4. **Package the buyer offer clearly.**
...
8. **Improve public discovery and SEO.**
...
9. **Create marketing landing pages.**
...
10. **Prepare launch and sales outreach.**
...
13. **Refine gallery merchandising layout.**
...
16. **Replace keyword removal with Owner keyword cleanup modal.**
...
17. **Make country collections open-ended.**
...
18. **Add gallery multi-select Owner metadata edits.**
...
21. **Keep long-horizon media and repo cleanup on the backburner.**
