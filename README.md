...
- Current visible version: `v83.20`
...
- `v83.17` keeps that stats panel restart-honest: Processed this run now counts successfully imported photos only, while failed attempts are shown as failures instead of being treated as future already-current skips.
