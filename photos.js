...
const translations = {
  en: {
    ...
    'home.moved_blocked': '{title} moved to Blocked.',
    'home.block_failed': 'Could not move photo to Blocked.',
    'home.discarded': '{title} discarded.',
    'home.discard_failed': 'Could not discard photo.',
    'home.undo_failed': 'Could not undo the last block.',
    'home.nothing_to_undo': 'No local blocked mark to undo.',
    'home.undo_done': 'Last local blocked mark undone.',
    ...
    'order.building_message': 'Payment is complete. We are building your private ZIP now; this can take up to 10 minutes for full-resolution or multi-photo orders.',
  ...
  fr: {
    ...
    'home.moved_blocked': '{title} deplace vers Blocked.',
    'home.block_failed': 'Impossible de deplacer la photo vers Blocked.',
    'home.discarded': '{title} supprime.',
    'home.discard_failed': 'Impossible de supprimer la photo.',
    'home.undo_failed': 'Impossible d annuler le dernier blocage.',
    'home.nothing_to_undo': 'Aucun blocage local a annuler.',
    'home.undo_done': 'Dernier blocage local annule.',
    ...
    'order.building_message': 'Le paiement est termine. Nous preparons votre ZIP prive; cela peut prendre jusqu a 10 minutes pour les commandes en pleine resolution ou avec plusieurs photos.',
  ...
  es: {
    ...
    'home.moved_blocked': '{title} movida a Blocked.',
    'home.block_failed': 'No se pudo mover la foto a Blocked.',
    'home.discarded': '{title} descartada.',
    'home.discard_failed': 'No se pudo descartar la foto.',
    'home.undo_failed': 'No se pudo deshacer el ultimo bloqueo.',
    'home.nothing_to_undo': 'No hay bloqueo local para deshacer.',
    'home.undo_done': 'Ultimo bloqueo local deshecho.',
    ...
    'order.building_message': 'El pago esta completo. Estamos creando el ZIP privado; puede tardar hasta 10 minutos para pedidos de resolucion completa o con varias fotos.',
