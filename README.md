...
- Daily automation `pbe-daily-social-posts` prepares Facebook, Instagram, and Pinterest post packages from watermarked public assets, publishing only when existing authentication allows it and otherwise leaving ready-to-publish captions and image lists. The 2026-05-23 Facebook Page package was manually published and verified; Instagram and Pinterest still need final publish confirmation.
