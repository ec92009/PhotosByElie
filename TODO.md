...
- Local Owner page: use the Dock launcher or the active helper port near 8000, currently `http://localhost:8000/owner.html?v=89.15`.
- Public slideshow music app: `https://ec92009.github.io/PhotosByElie/slideshow-music.html?v=89.15`.
...
- Latest checkpoint is `v89.15`; this file remains the numbered backlog source of truth.
