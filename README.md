...
- `slideshow-music.html`: public mini-app with original subdued Spanish-style guitar cues, per-track play/pause, seeking, MP3 links, and volume controls for real estate slideshow use
