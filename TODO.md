...
1. **Review and tune buyer support/refund wording.**
...
8. **Verify Owner-private artifact separation after deploy.**
...
9. **Run the next generator pass after the current batch is resolved.**
...
10. **Escalate thin ordinary title/keyword rows to stronger context.**
...
11. **Run a full Real Estate client lifecycle rehearsal.**
...
12. **Polish Real Estate production outputs and access.**
