...
- Current visible version: `v89.16`
...
- `slideshow-music.html`: public mini-app with original subdued Spanish/classical guitar cues plus CC0 public-domain Spanish-guitar references, per-track play/pause, seeking, MP3/source/license links, and volume controls for real estate slideshow use
